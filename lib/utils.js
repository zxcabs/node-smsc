...
var extend = module.exports.extend = function extend(target, obj) {
	var _obj = obj, _target = target, _prop = {}, _keys = Object.keys(_obj);

	_keys.forEach(function (key){
		_prop[key] = {value: _obj[key], writable: true};
	});
